...
|------|----------------|
| **CPU数量** | 72颗 Vera CPU |
| **CPU核心总数** | 6,336核 (88 × 72) |
| **CPU线程总数** | 12,672线程 |
| **CPU内存总量** | 108 TB (1.5TB × 72) |
| **CPU-GPU总带宽** | 129.6 TB/s (1.8TB/s × 72) |
...
Vera CPU不是独立产品，而是Vera Rubin AI工厂平台的关键组件。NVIDIA通过CPU+GPU+网络的**三件套协同设计**，构建完整生态壁垒。
...
3. **智源社区** — GTC 2026技术解析
4. **至顶网** — Vera Rubin平台报道
5. **本地源文件**: `/Users/mac/storage/clawbot/gtc2026-leaks/AI训练芯片泄露信息汇总.md`
